function [ panel_pos, fig, all_ax ] = panelFigureSetup( panel_x, panel_y, labels, figure_width, panel_spacing_paper, ...
    panel_margin_paper, panel_aspect_ratio )
...
panel_height_paper = panel_width_paper * panel_aspect_ratio;
figure_height = panel_height_paper * panel_y + panel_spacing_paper * (panel_y - 1) + 2 * panel_margin_paper;
panel_spacing_y = panel_spacing_paper / figure_height;
panel_margin_y = panel_margin_paper / figure_height;
panel_height = panel_height_paper / figure_height;
...
for i = 1 : panel_x * panel_y
    ...
    h = text(panel_pos(i,1)-panel_spacing_x/4, panel_pos(i,2) + panel_pos(i,4) + panel_spacing_y/8, labels(i), ...
        'fontweight', 'bold'); %%
