...
capstr = [];
savefig(fullfile(figures_path, 'Figure_2_March6_2021'), fig, true, capstr, 600);
...
%     set(gca, 'ytick', 0:1)
    ...
    if iM ==1;
        ...
        if char_num == 1; ylim([0 1.2]); set(gca,'ytick', 0:1.2:1.2);
            text(-.05, 1.6, 'd', 'fontweight','bold', 'fontsize', 9)
        elseif char_num == 2; ylim([0 .7]); set(gca,'ytick', 0:.5:.5);
        elseif char_num == 4; ylim([-0.3 .6]); set(gca,'ytick', 0:.5:.5);
        elseif char_num == 3; ylim([0 2]); set(gca,'ytick', 0:.8:.8);end
    end
end
...
capstr = [];
savefig(fullfile(figures_path, 'Figure_3_March6_2021'), fig, true, capstr, 600);
