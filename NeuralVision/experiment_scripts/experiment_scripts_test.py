...
def main():
    ...
    path = "/media/yipeng/data/movie_2021/Movie_Analysis/CNN_result/LSTM_multi_2_KLD_fake_label"
    ...
    result_folder = os.path.join(project_folder,"final_result_outputs_fake_label")
    MTL = True
    use_original = True
    if "LSTM" in path:
        if MTL:
