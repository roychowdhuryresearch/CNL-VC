...
workdir = "./signal_vis_1/"
#os.mkdir("./signal_vis_1/")
#bill
...
group_list2 = [46,503,524, 1156, 1573] #fat guy
group_list3 = [132,520, 861, 886, 2284, 3334] #yellow lady
group_list4 =  [193,204,212,216,373,383,395,414,428,435,841, 854,1273, 1281, 1283, 1289, 130, 1319,1927, 1938, 2109, 1032, 2366, 2404, 3186, 3438, 3667, 4071] # chloe
...
# CIA
#group_list = [936, 1048, 1058, 1973, 2008, 3048, 3101, 560, 1635, 3971, 560, 1635, 3971, 4294, 5867, 6931, 7406,352] 
...
save_dir = workdir + str(group_list[0][0]) + "/"
clean_folder(save_dir)
offset = 20
for neural_index in neural_signals.keys():
    plt.close("all")
    base = 40
    time_line_result = neural_signals[neural_index][0:2520]
    print(time_line_result.shape)
    plt.figure(figsize=(40,4))
    for k in list(sorted(group_time_line_result.keys())):
        base = base - offset
