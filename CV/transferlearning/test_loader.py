...
class CharacterDataset(Dataset):
    ...
    def get_images_labels(self, root_dir): 
        ...
        image_fns = image_fns_yes + image_fns_no
        return image_fns, None
    ...
    def __getitem__(self, ind):
        ...
        - A tuple (image, label)
        """
        image = Image.open(self.root_dir + self.image_fns[ind]) 
        ...
        return image, self.image_fns[ind]
...
def create_split_loaders(root_dir, batch_size, seed=0, transform=transforms.ToTensor(),
    ...
    sample_train = SubsetRandomSampler(all_indices)
